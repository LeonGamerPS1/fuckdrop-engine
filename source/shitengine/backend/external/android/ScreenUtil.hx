package shitengine.backend.external.android;
...
class ScreenUtil
{
	...
	{
		final getCutoutDimensionsJNI:Null<Dynamic> = JNI.createStaticMethod('funkin/util/ScreenUtil', 'getCutoutDimensions', '()[Landroid/graphics/Rect;');
		...
		if (getCutoutDimensionsJNI != null)
		{
			...
			for (rectangle in cast(getCutoutDimensionsJNI(), Array<Dynamic>))
			{
				...
				final topJNI:Null<JNIMemberField> = JNI.createMemberField('android/graphics/Rect', 'top', 'I');
				final leftJNI:Null<JNIMemberField> = JNI.createMemberField('android/graphics/Rect', 'left', 'I');
				final rightJNI:Null<JNIMemberField> = JNI.createMemberField('android/graphics/Rect', 'right', 'I');
				final bottomJNI:Null<JNIMemberField> = JNI.createMemberField('android/graphics/Rect', 'bottom', 'I');
