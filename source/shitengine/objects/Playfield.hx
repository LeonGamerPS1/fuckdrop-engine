...
import shitengine.objects.ui.HealthIcon;

class Playfield extends FlxGroup implements shitengine.backend.graphics.ModchartBackend.IModchartInstance
{
	...
	{
		shitengine.backend.graphics.ModchartBackend.instance = this;
