...
import shitengine.backend.gameplay.SongLoader;
import shitengine.backend.scripting.Hscript;
import shitengine.backend.scripting.NxScriptM;
import shitengine.backend.scripting.ScriptBase;
...
class PlayState extends flixel.addons.transition.FlxTransitionableState
{
	...
	override public function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.SEVEN)
			FlxG.switchState(() -> new shitengine.states.gameplay.Charter(song));
		#end
